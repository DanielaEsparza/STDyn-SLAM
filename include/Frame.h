...
#include "MapPoint.h"
#include "/home/lapyr/ORB_SLAM2/Thirdparty/DBoW2/DBoW2/BowVector.h"
#include "/home/lapyr/ORB_SLAM2/Thirdparty/DBoW2/DBoW2/FeatureVector.h"
...
public:
    ...
    Frame(const cv::Mat &imLeft, const cv::Mat &imRight, const cv::Mat &imDepth,const double &timeStamp, ORBextractor* extractorLeft, ORBextractor* extractorRight, ORBVocabulary* voc, const float &thDepth);
    ...
    void CalculEverythingStereo(cv::Mat &imRGB, const cv::Mat &imLeft, const cv::Mat &imRight, const cv::Mat &imDepth,const cv::Mat &imS);
    ...
    int flag_mov ;
    std::vector<std::vector<cv::KeyPoint>> mvKeysTemp, mvKeysTempRight;
    std::vector<cv::KeyPoint> mvKeysPreGraphleft,mvKeysPreGraphright;
