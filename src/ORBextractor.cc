	...
	for (int i = 0; i < T.size(); i++)
	{
	    for(int m = -15; m < 15; m++) 
	    {
	        for(int n = -15; n < 15; n++)
	        {
		        ...
		        if((int)imS.ptr<uchar>(my)[mx] == PEOPLE_LABLE || (int)imS.ptr<uchar>(my)[mx] == 1 || 
		        (int)imS.ptr<uchar>(my)[mx] == 2 || (int)imS.ptr<uchar>(my)[mx] == 3 || (int)imS.ptr<uchar>(my)[mx] ==6 || 
		        (int)imS.ptr<uchar>(my)[mx] ==7 || (int)imS.ptr<uchar>(my)[mx] == 8 || (int)imS.ptr<uchar>(my)[mx] == 12 || 
		        (int)imS.ptr<uchar>(my)[mx] == 13 || (int)imS.ptr<uchar>(my)[mx] == 14 || (int)imS.ptr<uchar>(my)[mx] ==19)
		        {
		            flag_orb_mov=1;
		               break;
		        }
	    ...
	    for (int level = 0; level < nlevels; ++level)
            {
                ...
                while(keypoint != mkeypoints.end())
	            {
		             ...
		             if(label_coord == PEOPLE_LABLE || label_coord == 1 || label_coord == 2 || label_coord == 3 || 
		             label_coord ==6 || label_coord ==7 || label_coord == 8 || label_coord == 12 || label_coord == 13 || 
		             label_coord == 14 || label_coord ==19) 
		             {
